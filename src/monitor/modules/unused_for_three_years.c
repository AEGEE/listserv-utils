...
char
unused_for_three_years_LTX_changed_list (struct listserv *l __attribute__ ((unused)),
				   const char const * listname)
{
  return (g_hash_table_lookup_extended (unused_for_three_years_hashtable,
...
Your list was not used in the last three years.  Would you mind if it is deleted?\r\n\
