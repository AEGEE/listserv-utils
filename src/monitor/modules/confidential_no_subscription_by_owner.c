...
\r\n\
Your list does not conform to the last criteria - the subscription request from\r\n\
potential new lists members is subject to approval by the list owners.\r\n\
...
subscription process unconditional.  If your body prefers to have another list\r\n\
visible, then you must make this one invisible.\r\n\
\r\n\
