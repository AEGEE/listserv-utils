...
\r\n\
Your list does not conform to the last criteria - non-members cannot request to\r\n\
join ", listname, ".  Provided that your antenna, project or working group does\r\n\
not yet have a visible mailing lists you can choose between hiding the list or\r\n\
making the subscription process unconditional.  If your body prefers to have\r\n\
another list visible, then you must make this one invisible.\r\n\
\r\n\
...
\r\n\
To make ", listname, " invisible, find the keyword *Confidential* and set its value\r\n\
to \"Yes\".\r\n\
\r\n\
